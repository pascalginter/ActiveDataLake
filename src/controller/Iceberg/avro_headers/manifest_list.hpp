...
#ifndef MANIFEST_LIST_HPP_2399627152_H
#define MANIFEST_LIST_HPP_2399627152_H
...
public:
    ...
    const std::vector<r508 >& get_array() const;
    std::vector<r508 >& get_array();
    void set_array(const std::vector<r508 >& v);
    void set_array(std::vector<r508 >&& v);
    _manifest_list_json_Union__2__();
};

struct manifest_file {
    typedef _manifest_list_json_Union__2__ partitions_t;
...
inline
const std::vector<r508 >& _manifest_list_json_Union__2__::get_array() const {
    if (idx_ != 1) {
...
inline
std::vector<r508 >& _manifest_list_json_Union__2__::get_array() {
    if (idx_ != 1) {
        throw avro::Exception("Invalid type for union _manifest_list_json_Union__2__");
    }
    return *std::any_cast<std::vector<r508 > >(&value_);
...
inline
void _manifest_list_json_Union__2__::set_array(const std::vector<r508 >& v) {
    idx_ = 1;
    value_ = v;
}

inline
void _manifest_list_json_Union__2__::set_array(std::vector<r508 >&& v) {
    idx_ = 1;
    value_ = std::move(v);
}
...
template<> struct codec_traits<_manifest_list_json_Union__2__> {
    static void encode(Encoder& e, _manifest_list_json_Union__2__ v) {
        e.encodeUnionIndex(v.idx());
        switch (v.idx()) {
        case 0:
            e.encodeNull();
    ...
    static void decode(Decoder& d, _manifest_list_json_Union__2__& v) {
        size_t n = d.decodeUnionIndex();
        if (n >= 2) { throw avro::Exception("Union index too big"); }
        switch (n) {
        case 0:
